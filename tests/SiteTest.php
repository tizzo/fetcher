...
class SiteTest extends PHPUnit_Framework_TestCase {
  ...
  public function testEnsureWorkingDirectory() {
    ...
    Phake::verify($system)->ensureFolderExists('/var/www/test/public_files', NULL, 'apache', 0755);
    Phake::verify($system)->ensureFolderExists('/var/www/test/private_files', NULL, 'apache', 0755);
